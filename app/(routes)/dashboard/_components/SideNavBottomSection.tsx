...
import { Github, Flag, Archive } from 'lucide-react'
      ...
      {menuList.map((menu,index)=>(
        <h2 key={index} className='flex gap-2 p-1 px-2 text-[14px] hover:bg-gray-100 rounded-md cursor-pointer'>
           ...
           {menu.name}</h2>
            ...
            {/* New File */}
            <Dialog>
  <DialogTrigger className='w-full' asChild><Button className='w-full bg-blue-600 hover:bg-blue-700 justify-start mt-3'>
            New File
 ...
 {totalFiles<Constant.MAX_FREE_FILE? <DialogContent>
    ...
    <div className='h-4 w-full bg-gray-200 rounded-full mt-5'>
       ...
       <strong>{totalFiles} </strong>   Out of <strong> {Constant.MAX_FREE_FILE} </strong> Files Used
        ...
        <strong> Upgrade your plan for unlimited resources</strong>  
